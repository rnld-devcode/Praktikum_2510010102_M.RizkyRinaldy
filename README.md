  ...
  <tr>
    <td width="60%">
      ...
      <ul>
        ...
        <li><b>Soal: </b> Percabangan (Selection)Buatlah program yang menentukan status kelulusan mahasiswa berdasarkan nilai akhir. Jika nilai >= 60 maka dinyatakan LULUS, selain itu TIDAK LULUS. </li>
        <li><b>SourceCode:</b> 
